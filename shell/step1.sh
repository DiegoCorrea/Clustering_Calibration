...
python3 step1_preprocessing.py from_file=YES file_name=twitter_movies_cross &&
python3 step1_preprocessing.py from_file=YES file_name=twitter_movies_class_distribution_cross &&
python3 step1_preprocessing.py from_file=YES file_name=twitter_movies_distribution_cross &&
python3 step1_preprocessing.py from_file=YES file_name=twitter_movies_ohe_cross